...
#pragma mark 初始化
- (void)setup {
    [self setSyflashModel:SYCameraManagerFlashModeAuto];
...
#pragma mark 摄像头位置
- (void)setSyposition:(SYCameraDevicePosition)syposition {
    _syposition = syposition;
    switch (syposition) {
        case SYDevicePositionBack: {
...
- (void)setSyflashModel:(SYCameraDeviceFlashModel)flashMode {
    _syflashModel = flashMode;
    switch (flashMode) {
